    ...
    while True:
        try:
            ...
            try:
                ...
                if cpu_total_str and "Error" not in cpu_total_str:
                    server_cpu = float(cpu_total_str.strip())
            except Exception:
                pass
            
            server_ram_used, server_ram_total = 0.0, 1000.0
            try:
            ...
            server_disk_used, server_disk_total = 0.0, 1000.0
            try:
            ...
            try:
                ...
                server_temp = float(temp_str) / 1000.0 if temp_str.strip().isdigit() else 0.0
            except Exception:
                pass
